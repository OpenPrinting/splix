 ...
 * There does not seem to be a general formula for all paper sizes, hence simple lookup
 */
unsigned long _get2020BandWidthInB(unsigned char papertype, unsigned long xresolution) {
    struct Bw {
